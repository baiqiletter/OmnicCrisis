...
public class EnemyController : MonoBehaviour
{
    ...
    public bool TryAtack(Vector3 enemyPosition)
    {
        ...
        FindAndInitializeAllWeapons();
        //Debug.Log(m_Weapons.Length);

        bool didFire = true;
        foreach (var m_weapon in m_Weapons)
        {
            didFire &= m_weapon.HandleShootInputs(false, true, false);
        }
    ...
    void FindAndInitializeAllWeapons()
    {
        ...
        if (m_Weapons == null || m_Weapons.Length != weaponNum)
        {
            //m_Weapons = GetComponentsInChildren<WeaponController>();
            //DebugUtility.HandleErrorIfNoComponentFound<WeaponController, EnemyController>(m_Weapons.Length, this, gameObject);
